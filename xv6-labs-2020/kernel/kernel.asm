...
0000000080001da2 <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  np->syscall_trace = p->syscall_trace; // HERE!!! 子进程继承父进程的 syscall_trace
    80001e82:	16893783          	ld	a5,360(s2)
    80001e86:	16f9b423          	sd	a5,360(s3)
  pid = np->pid;
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) { // 如果系统调用编号有效
    ...
    80002b70:	dac78793          	addi	a5,a5,-596 # 80008918 <syscall_names>
...
sys_trace(void)
{
  ...
  int mask;
  if(argint(0, &mask) < 0)
    80002bc6:	fdc40593          	addi	a1,s0,-36
  ...
  if(argint(0, &mask) < 0)
    80002bd6:	00054b63          	bltz	a0,80002bec <sys_trace+0x30>
  myproc()->syscall_trace = mask;
    80002bda:	fdc42483          	lw	s1,-36(s0)
    80002bde:	fffff097          	auipc	ra,0xfffff
    80002be2:	e00080e7          	jalr	-512(ra) # 800019de <myproc>
    80002be6:	16953423          	sd	s1,360(a0)
  return 0;
...
sys_exit(void)
{
  ...
  if(argint(0, &n) < 0)
    ...
    80002c0a:	e9e080e7          	jalr	-354(ra) # 80002aa4 <argint>
    return -1;
  ...
  exit(n);
    ...
    80002c1c:	498080e7          	jalr	1176(ra) # 800020b0 <exit>
...
sys_getpid(void)
{
  ...
  return myproc()->pid;
    ...
    80002c38:	daa080e7          	jalr	-598(ra) # 800019de <myproc>
}
...
sys_fork(void)
{
  ...
  return fork();
    ...
    80002c52:	154080e7          	jalr	340(ra) # 80001da2 <fork>
}
...
sys_wait(void)
{
  ...
  if(argaddr(0, &p) < 0)
    ...
    80002c70:	e5a080e7          	jalr	-422(ra) # 80002ac6 <argaddr>
  ...
  return wait(p);
    ...
    80002c84:	5f4080e7          	jalr	1524(ra) # 80002274 <wait>
}
...
sys_sbrk(void)
{
  ...
  if(argint(0, &n) < 0)
    ...
    80002ca4:	e04080e7          	jalr	-508(ra) # 80002aa4 <argint>
    80002ca8:	87aa                	mv	a5,a0
    return -1;
    80002caa:	557d                	li	a0,-1
  if(argint(0, &n) < 0)
    80002cac:	0207c063          	bltz	a5,80002ccc <sys_sbrk+0x3c>
  addr = myproc()->sz;
    80002cb0:	fffff097          	auipc	ra,0xfffff
    80002cb4:	d2e080e7          	jalr	-722(ra) # 800019de <myproc>
    80002cb8:	4524                	lw	s1,72(a0)
  if(growproc(n) < 0)
    80002cba:	fdc42503          	lw	a0,-36(s0)
    80002cbe:	fffff097          	auipc	ra,0xfffff
    80002cc2:	070080e7          	jalr	112(ra) # 80001d2e <growproc>
    80002cc6:	00054863          	bltz	a0,80002cd6 <sys_sbrk+0x46>
    return -1;
  return addr;
    ...
    80002cd8:	bfd5                	j	80002ccc <sys_sbrk+0x3c>
...
sys_sleep(void)
{
  ...
  if(argint(0, &n) < 0)
    ...
    80002cf2:	db6080e7          	jalr	-586(ra) # 80002aa4 <argint>
    return -1;
  ...
  acquire(&tickslock);
    ...
    80002d00:	c6c50513          	addi	a0,a0,-916 # 80017968 <tickslock>
    80002d04:	ffffe097          	auipc	ra,0xffffe
    80002d08:	f0c080e7          	jalr	-244(ra) # 80000c10 <acquire>
  ticks0 = ticks;
  ...
  while(ticks - ticks0 < n){
    ...
    80002d3e:	4bc080e7          	jalr	1212(ra) # 800021f6 <sleep>
  while(ticks - ticks0 < n){
  ...
  release(&tickslock);
    ...
    80002d54:	c1850513          	addi	a0,a0,-1000 # 80017968 <tickslock>
    80002d58:	ffffe097          	auipc	ra,0xffffe
    80002d5c:	f6c080e7          	jalr	-148(ra) # 80000cc4 <release>
  return 0;
    ...
    80002d7e:	f4a080e7          	jalr	-182(ra) # 80000cc4 <release>
      return -1;
...
sys_kill(void)
{
  ...
  if(argint(0, &pid) < 0)
    ...
    80002d98:	d10080e7          	jalr	-752(ra) # 80002aa4 <argint>
  ...
  return kill(pid);
    ...
    80002dac:	63e080e7          	jalr	1598(ra) # 800023e6 <kill>
}
